...
import { useSetCATNameMutation, useGetCatListQuery } from '@AppleOfEnlightenment/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@AppleOfEnlightenment/core';
import { Offers as OffersIcon } from '@AppleOfEnlightenment/icons';
