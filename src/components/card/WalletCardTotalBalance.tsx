import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@AppleOfEnlightenment/api-react';
import { CardSimple, Flex, TooltipIcon } from '@AppleOfEnlightenment/core';
