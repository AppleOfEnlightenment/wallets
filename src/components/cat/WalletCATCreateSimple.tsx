import type { CATToken } from '@AppleOfEnlightenment/api';
import { SyncingStatus } from '@AppleOfEnlightenment/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@AppleOfEnlightenment/api-react';
import { Back, Flex, Loading, useShowError } from '@AppleOfEnlightenment/core';
