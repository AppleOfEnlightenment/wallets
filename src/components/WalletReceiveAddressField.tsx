import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@AppleOfEnlightenment/api-react';
import { Flex, Loading, truncateValue, useColorModeValue } from '@AppleOfEnlightenment/core';
import { Reload } from '@AppleOfEnlightenment/icons';
